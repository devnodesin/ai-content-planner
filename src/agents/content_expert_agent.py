"""Content Expert agent for generating content ideas."""
...
class ContentExpertAgent:
    """AI agent that acts as a content expert generating article ideas."""

    def __init__(self, api_key: Optional[str] = None, model: Optional[str] = None):
        """
        Initialize the content expert agent.
        ...
        if self.api_key and self.api_key != 'your_api_key_here':
            try:
                ...
                print(f"Warning: Could not initialize content expert agent: {e}")
                self.is_available = False
    ...
    def generate_content_ideas(
        ...
        existing_ideas: Optional[List[Dict[str, str]]] = None
    ) -> List[Dict[str, str]]:
        """
